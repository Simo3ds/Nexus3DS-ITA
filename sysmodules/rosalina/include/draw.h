...
#define COLOR_LIGHT_BLUE RGB8_to_565(0x80, 0xC0, 0xFF)
#define COLOR_ORANGE RGB8_to_565(0xFF, 0x80, 0x00)
#define COLOR_PURPLE RGB8_to_565(0x80, 0x40, 0xFF)
#define COLOR_CYAN   RGB8_to_565(0x00, 0xFF, 0xFF)
