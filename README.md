...
As you can see, the code for the added features by [me](https://github.com/2b-zipper) sucks (because my knowledge of C is severely lacking), so don't expect too much.
